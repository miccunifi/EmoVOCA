...
def main():
    ...
    parser.add_argument('--mesh_path', type=str, default='Florence4D/',
                        help="Path to the directory containing Florence4D COMA data.")
    parser.add_argument('--cond_path', type=str, default='Conditions/',
    ...
    generate_condition_meshes(args.mesh_path, args.cond_path, args.expressions)
