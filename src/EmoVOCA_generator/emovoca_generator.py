...
def generate_emovoca(args, label_dict, data_dict):
    ...
    template_flame = args.template_flame
...
def main():
    # Argument parsing
    parser = argparse.ArgumentParser(description="Audio-to-animation pipeline")
    parser.add_argument('--neutral_sequences_path', type=str, default='/mnt/diskone-first/TH/S2L/vocaset/vertices_npy', help="Path to neutral sequences.")
    parser.add_argument('--audio_path', type=str, default='/mnt/diskone-first/TH/S2L/vocaset/wav', help="Path to audio files.")
    parser.add_argument('--model_path', type=str, default='/mnt/diskone-second/D2D/Results/d2d_new_naima_loss.pth.tar', help="Path to pre-trained model.")
    parser.add_argument('--conditions_path', type=str, default='/mnt/diskone-second/D2D/New_Conditions', help="Path to conditions.")
    parser.add_argument('--coma_templates', type=str, default='/mnt/diskone-second/COMA_Florence_Actors_Aligned', help="Path to COMA templates.")
    parser.add_argument('--template_flame', type=lambda x: trimesh.load(x, process=False), default='/mnt/diskone-second/D2D/template/flame_model/FLAME_sample.ply', help="Path to FLAME template.")
    parser.add_argument('--intensities', type=int, nargs='+', default=[1, 2, 3], help="List of intensities.")
    parser.add_argument('--seq_path', type=str, default='/mnt/diskone-first/New_Dataset2/sequences', help="Path to save sequences.")
    parser.add_argument('--label_path', type=str, default='/mnt/diskone-first/New_Dataset2/label', help="Path to save labels.")
    parser.add_argument('--intensity_path', type=str, default='/mnt/diskone-first/New_Dataset2/intensity', help="Path to save intensities.")
    parser.add_argument('--new_audio_path', type=str, default='/mnt/diskone-first/New_Dataset2/wav', help="Path to save audio.")
